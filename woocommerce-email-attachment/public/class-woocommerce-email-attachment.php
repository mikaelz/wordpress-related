 ...
 * @author    Michal Zuber <info@nevilleweb.sk>
 */
class Woocommerce_Email_Attachment {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'woocommerce-email-attachment';
	...
	private function __construct() {
		...
		add_filter( 'woocommerce_email_attachments', array( $this, 'add_attachment' ), 10, 2 );
